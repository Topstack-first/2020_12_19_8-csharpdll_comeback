namespace GTA.NaturalMotion
{
    ...
    public sealed class ConfigureBulletsHelper : CustomHelper
    {
        ...
        {
            set => 
                base.SetArgument("impulseLeakageStrengthScaled", value);
        }
        ...
        public float ImpulseReductionPerShot
        {
            set
            {
                ...
                base.SetArgument("impulseReductionPerShot", value);
            }
        }
        ...
        public float ImpulseRecovery
        {
            set
            {
                ...
                base.SetArgument("impulseRecovery", value);
            }
        }
        ...
        public float ImpulseMinLeakage
        {
            set
            {
                ...
                base.SetArgument("impulseMinLeakage", value);
            }
        }
